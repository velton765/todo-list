...
export function NewNoteCard({onNoteCreated}:NewNoteCardProps){
    ...
    function handleStartRecording(){
      const isSpeechRecognitionAPIAvailable = 'SpeachRecognition' in window
    ...
    return(
     <Dialog.Root>  
        <Dialog.Trigger className="rounded-md flex flex-col bg-slate-700 text-left p-5 gap-3 overflow-hidden relative outline-none hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400">
       ...
       <Dialog.Portal>
          ...
          <Dialog.Close className=" absolute right-0 top-0 bg-slate-800 p-1.5 text-slate-600 hover:text-slate-100">
            <X className="size-5" />         
         </Dialog.Close>
